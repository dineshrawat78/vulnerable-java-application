...
$apiKey = 'sec1-1234';
$sec1ApiKey = '1234567898765432123456789876543212345678987654321234567898765432123456789876543212345678987654321234567898765432';
$passKey = 'sec2-23456';
$password = 'Test@1234';
...
if (strlen($id) > 0) {
  ...
  $query = $db->query('select * from secrets where id = ' . $id);
